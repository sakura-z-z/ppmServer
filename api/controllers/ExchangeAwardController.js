...
module.exports = {
  exchangeAward: function(request, response, callback) {
    ...
    GlobalMethods.httpPost(request, response, callback, GlobalVal.apiHost, '/ppmiao-rest/payment/activity/inviteFriend/exchangeAward.htm', data, GlobalVal.apiPort);
  },
  ...
  getLotteryLogByLotteryAwardId: function(request, response, callback) {
    ...
    console.log(GlobalVal.apiHost);
    GlobalMethods.httpPost(request, response, callback, GlobalVal.apiHost, '/ppmiao-rest/payment/activity/inviteFriend/getLotteryLogByLotteryAwardId.htm', data, GlobalVal.apiPort);
  },
