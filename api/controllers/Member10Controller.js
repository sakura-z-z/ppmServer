...
module.exports = {
  getUserInfoMT: function(request, response, callback) {
    ...
    let sql4 = "select * from ppmiao_test.s_user_due_detail where start_time > '2017-09-27 16:13:29.000000' and user_id= " + userInfo.id;
    console.log(sql1);
    console.log(sql2);
    console.log(sql4);
    query(sql1 + sql2 + sql4, function(err, rows, fields) {
      if (err) {
